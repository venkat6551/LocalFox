...
public enum FloatingButtonAlignment {
...
public struct FloatingButton<MainView, ButtonView>: View where MainView: View, ButtonView: View {
    ...
    fileprivate var alignment: FloatingButtonAlignment = .center
...
public extension FloatingButtonGeneric where T: StraightFloatingButton {
    ...
    func alignment(_ alignment: FloatingButtonAlignment) -> FloatingButtonGeneric {
        var copy = self
